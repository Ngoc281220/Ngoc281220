...
<table style="width: 100%;" border="1" style="border-collapse: collapse;">
	...
	<tr>
		...
		<td><a href="modules/quanlybaiviet/xuly.php?idbaiviet=<?php echo $row['id']?>">Xóa</a>|<a href="index.php?action=quanlybaiviet&query=sua&idbaiviet=<?php echo $row['id']?>">Sửa</a></td>
	</tr>
	<?php 
}
	?>
